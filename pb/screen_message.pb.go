...
type Screen struct {
	...
	Panel      Screen_Panel       `protobuf:"varint,3,opt,name=panel,proto3,enum=shivuslr41.pcbook.Screen_Panel" json:"panel,omitempty"`
...
var file_screen_message_proto_rawDesc = []byte{
	...
	0x34, 0x31, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x22, 0xa7, 0x02, 0x0a, 0x06, 0x53, 0x63,
	...
	0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x24, 0x2e, 0x73, 0x68, 0x69, 0x76, 0x75, 0x73, 0x6c, 0x72,
	0x34, 0x31, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x53, 0x63, 0x72, 0x65, 0x65, 0x6e,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1f, 0x2e, 0x73, 0x68, 0x69, 0x76, 0x75, 0x73, 0x6c,
	0x72, 0x34, 0x31, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x53, 0x63, 0x72, 0x65, 0x65,
...
var file_screen_message_proto_goTypes = []interface{}{
	(Screen_Panel)(0),         // 0: shivuslr41.pcbook.Screen.Panel
	(*Screen)(nil),            // 1: shivuslr41.pcbook.Screen
	(*Screen_Resolution)(nil), // 2: shivuslr41.pcbook.Screen.Resolution
}
var file_screen_message_proto_depIdxs = []int32{
	2, // 0: shivuslr41.pcbook.Screen.resolution:type_name -> shivuslr41.pcbook.Screen.Resolution
	0, // 1: shivuslr41.pcbook.Screen.panel:type_name -> shivuslr41.pcbook.Screen.Panel
